...
test_list <- read.csv("inst/test-data/ed2-test-list.csv", comment.char = "#",
                      na.strings = "") %>%
  as_tibble() %>%
...
write.csv(error_data, "data/ed2-test/logs/ed2-log-data.csv")
...
write.csv(stages, "data/ed2-test/ed2-test_results.csv")
