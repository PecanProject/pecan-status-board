...
mod_basgra_ui <- function(id){
  ns <- NS(id)
  # count <- basgra_report()
  # basgra_count <- workflow_count(count)
...
#' basgra Server Functions
#'
#' @noRd 
mod_basgra_server <- function(id){
  moduleServer( id, function(input, output, session){
    ns <- session$ns
  #   result <- basgra_report()
  ...
  #     error_data = read.csv("data/basgra-test/logs/basgra-log-data.csv")
